...
def profile(request, username=None, ):
	...
	return render(request, 'social/profile.html', {'user':user, 'posts':posts, 'current_path': request.get_full_path()})
...
def link (request, username):
	...
	context = {'urls': urls2, 'usuario': usuarios, 'user': user, 'colorboton': colorboton, 'colorfondo': colorfondo, 'urlimg': urlimg, 'portada': portada}
